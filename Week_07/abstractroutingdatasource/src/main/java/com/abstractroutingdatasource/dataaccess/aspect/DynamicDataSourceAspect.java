package com.abstractroutingdatasource.dataaccess.aspect;
...
import com.abstractroutingdatasource.dataaccess.datasource.DataSourceContextHolder;
...
public class DynamicDataSourceAspect {
    ...
    @Before("execution(*  com.abstractroutingdatasource.service..*.*(..))")
    ...
    @After("execution(*  com.abstractroutingdatasource.service..*.*(..))")
